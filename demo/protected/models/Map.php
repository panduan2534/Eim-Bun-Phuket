...
class Map extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('longtitude, latitude', 'required'),
			array('temple_detail_id', 'numerical', 'integerOnly'=>true),
			array('longtitude, latitude', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, longtitude, latitude, temple_detail_id', 'safe', 'on'=>'search'),
		);
	}
